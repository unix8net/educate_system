...
<body>
	...
	<div class="content">
		...
		<form action="<?php echo U('home/personinfo/showCurriculum');?>" method="post" class="form-search">
		 ...
		 <?php echo ($thead); ?>
		  <tbody>
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
					...
					<td><a href="<?php echo U('exam/exam');?>?cou_number=<?php echo ($vo["cou_number"]); ?>&cou_name=<?php echo ($vo["cou_name"]); ?>">查看考试</a></td>
